...
## Shared by ULTIMATE_HOW_TO_PLAY_BBCODE and ULTIMATE_SCORING_SYSTEM_BBCODE -
## the pattern descriptions and scoring table are identical content in both
## popups.
const ULTIMATE_PATTERNS_SECTION_BBCODE := (
	"All patterns must be chromo-numerical (color + number pattern).\n" +
	"• All patterns work the same in forward and reverse - e.g. 12345 = 54321\n" +
	"• There must be 4+ to make a pattern, the longer the better (more points)\n" +
	"• Some patterns require more than 4 cards minimum\n" +
	...
	"[b]Doublet[/b]\n" +
	"[indent]e.g. 1122 or 884477\n" +
	"• Can only be 4 or 6 cells/squares in length\n" +
	"• Repeating numbers allowed (e.g. 112211)\n" +
	"• Repeat numbers are not allowed consecutively (e.g. 1111)\n" +
	"• Colors must correspond to numbers (e.g. RRGG)[/indent]\n" +
	"Doublet Example:\n" +
	"[indent]Red-1, Red-1, Yellow-2, Yellow-2\n" +
	"Green-6, Green-6, Blue-3, Blue-3, White-0, White-0[/indent]\n\n" +
	...
	"• Can only be 7 squares/cells long\n" +
	"• Can apply to Run, Cluster or Alternating Run[/indent]\n" +
	"Full Spectrum Examples:\n" +
	"[indent]Red-1, Yellow-2, Green-3, Aqua-4, Blue-5, Purple-6, White-7\n" +
	"Aqua-5, Yellow-5, Purple-5, White-5, Blue-5, Red-5, Green-5\n" +
	"Blue-1, Yellow-2, Green-1, Purple-2, White-1, Aqua-2, Red-1[/indent]\n\n" +
	...
	"[b]Doublet:[/b]\n" +
	"[indent]4 cells in sequence = 2pts\n" +
	"6 cells in sequence = 10pts[/indent]\n" +
	"[b]Pyramid:[/b]\n" +
	"[indent]5 cells in sequence = 10pts\n" +
	"7 cells in sequence = 30pts[/indent]\n" +
	"[b]Plateau:[/b]\n" +
	"[indent]6 cells in sequence = 20pts\n" +
	"7 cells in sequence = 30pts[/indent]\n" +
	"[b]Staircase:[/b]\n" +
	"[indent]6 cells in sequence = 20pts[/indent]\n" +
	"[b]Full Spectrum:[/b]\n" +
	"[indent]7 cells in sequence = 40pts[/indent]\n\n" +
...
const ULTIMATE_HOW_TO_PLAY_BBCODE := (
	"[font_size=28][b]Chromodulus Ultimate - How to Play[/b][/font_size]\n" +
	"Includes the full spectrum of patterns.\n\n" +
	...
	"Aqua + Green = Not Allowed\n" +
	"Aqua + Red = White[/indent]\n" +
	"This system forces a color cycle where, if starting from a White cell, one each of Red, Green and Blue would have to be played before one of these colors could repeat.\n\n" +
	...
	"[font_size=20][b]Scoring Patterns[/b][/font_size]\n" +
	ULTIMATE_PATTERNS_SECTION_BBCODE
)

const ULTIMATE_SCORING_SYSTEM_BBCODE := (
	"[font_size=28][b]Chromodulus Ultimate Scoring System[/b][/font_size]\n\n" +
	ULTIMATE_PATTERNS_SECTION_BBCODE
)
